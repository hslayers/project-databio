    ...
    function(ol) {
        ...
        spoi_source.cesiumStyler = function(dataSource) {
            ...
            for (var i = 0; i < entities.length; i++) {
                ...
                s = s.split("#")[1];
                var allowed = 'archaeological_site.png  artwork.png fuel.png natural_feature.png water_point.png bank.png  food_and_drink.png drinking_water.png    cafe.png       car_wash.png  fast_food.png  hotel.png        library.png   other.png    place_of_worship.png  restaurant.png   viewpoint.png     zoo.png arts_centre.png          atm.png      bus_stop.png  camp_site.png  dentist.png   fountain.png   information.png  memorial.png  parking.png  pub.png              supermarket.png  waste_basket.png';
                if (allowed.indexOf(s + '.png') > -1)
                    s = 'symbols/' + s + '.png';
                else
                    s = 'symbols/other.png';
                entity.billboard.scaleByDistance = new Cesium.NearFarScalar(50, 1.5, 25000, 0.0);
                ...
                switch (entity.properties.category.getValue()) {
                    case 'http://gis.zcu.cz/SPOI/Ontology#peak':
                        entity.label = new Cesium.LabelGraphics({
                            ...
                            scaleByDistance: new Cesium.NearFarScalar(50, 1.5, 25000, 0.0),
                            heightReference: Cesium.HeightReference.CLAMP_TO_GROUND
                        });
                        break;
                    case 'http://gis.zcu.cz/SPOI/Ontology#village':
                    case 'http://gis.zcu.cz/SPOI/Ontology#city':
                        entity.label = new Cesium.LabelGraphics({
                            text: entity.properties.label,
                            font: '14px Helvetica',
                            fillColor: Cesium.Color.WHITE,
        ...
        return {
            ...
            createPoiLayer: function() {
                lyr = new ol.layer.Vector({
                    ...
                    source: spoi_source,
                    maxResolution: 4.777314267823516 * 2 * 2 * 2,
